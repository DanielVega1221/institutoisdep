/* =====================================================================================
   VERSIÓN ANTERIOR DE LA SECCIÓN DE CURSOS (acordeón con cards + CursoModal).
   Se conserva intacta y SIN IMPORTAR en ningún lado, por si el cliente quiere revertir.
   La versión nueva (dos dropdowns de Carreras y Cursos) está en ./Cursos.jsx
   Los datos ahora viven en ../../data/formaciones.js

   PARA REVERTIR: en src/pages/HomePage.jsx cambiar
     import Cursos from '../components/Cursos/Cursos';
   por
     import Cursos from '../components/Cursos/CursosAnterior';
   y descomentar allí el estado focusCarrera / expandCursos y sus props.
   ===================================================================================== */
...
// NUEVO (cambio de esta sesión): la imagen del fondo de la card se importa acá mismo.
// Antes venía de localImages.banners.cursosBanner; al quitarla de localImages, este
// import autónomo mantiene funcionando la versión anterior si se revierte HomePage.
...
const CursosAnterior = ({ focusCarrera, setFocusCarrera, expandCursos, setExpandCursos }) => {
