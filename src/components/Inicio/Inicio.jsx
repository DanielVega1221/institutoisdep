...
// Importar imagen optimizada
import fondoInicioOpt from '../../assets/optimized/fondoInicio.jpg';
...
const Inicio = () => {
  ...
  return (
    <section 
      ...
      style={{
        '--bg-image': `url(${fondoInicioOpt})`,
        backgroundImage: `url(${fondoInicioOpt})`
      }}
    >
