  ...
  <footer className="footer-main">
    <div className="footer-content">
      ...
      <div className="footer-col footer-col-left">
        ...
        <div className="footer-info">Tel: (0223) 491-5391</div>
      ...
      <div className="footer-col footer-col-center">
        ...
        <a href="mailto:info@isdep.edu.ar" className="footer-contact-btn">Contactar</a>
      </div>
      ...
      <div className="footer-col footer-col-right">
        ...
        <div className="footer-social-icons footer-social-icons-centered">
          <a href="https://wa.me/5492234915391" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
          ...
          <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <svg width="26" height="26" fill="none" viewBox="0 0 24 24"><rect width="18" height="18" x="3" y="3" rx="5" stroke="currentColor" strokeWidth="2"/><circle cx="12" cy="12" r="4" stroke="currentColor" strokeWidth="2"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor"/></svg>
          </a>
        ...
        <div className="footer-logo-centered">
          <img src={banderita} alt="Argentina" className="footer-banderita" />
